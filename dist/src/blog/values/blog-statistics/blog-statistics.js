 ...
 */
class BlogStatistics extends value_1.Value {
    /**
    ...
    constructor(bounces = 0, clicks = 0, views = 0) {
        ...
        if ((clicks < 0) ||
            ...
            throw new exceptions_well_1.BlogStaticsException();
        }
        this._clicks = clicks;
    ...
    incrementBounces(amount) {
        return new BlogStatistics(this.bounces() + amount, this.clicks(), this.views());
    }
    /**
     * incrementClicks()
     *
    ...
    incrementClicks(amount) {
        return new BlogStatistics(this.bounces(), this.clicks() + amount, this.views());
    }
    /**
     * incrementViews()
     *
    ...
    incrementViews(amount) {
        return new BlogStatistics(this.bounces(), this.clicks(), this.views() + amount);
    }
    serialize() {
...
exports.BlogStatistics = BlogStatistics;
